    ...
    <div className="flex items-center justify-center min-h-[calc(100vh-200px)] py-12 px-4">
      <Card className="w-full max-w-md shadow-2xl bg-card/80 backdrop-blur-lg border-border/50">
        <CardHeader className="text-center p-6 sm:p-8">
          <CardTitle className="text-3xl sm:text-4xl font-bold tracking-tight">Welcome Back</CardTitle>
          <CardDescription className="text-muted-foreground pt-2">Sign in to unlock the future of printing.</CardDescription>
        </CardHeader>
